...
export default function Proyectos () {
  const proyectos = [
    {
      titulo: "Proyecto 1",
      descripcion: "Aplicacion web con Boostrap",
      imagen: projImg1
    },
    {
      titulo: "Proyecto 2",
      descripcion: "Portafolio web sobre mi con JavaScript",
      imagen: projImg2
    },
    {
      titulo: "Proyecto 3",
      descripcion: "Aplicacion con NeatBeans sobre una calculadora",
      imagen: projImg3
    },
    {
      titulo: "Proyecto 4",
      descripcion: "Circuito con Bloethoot con Arduino",
      imagen: projImg4
    },
    {
      titulo: "Proyecto 5",
      descripcion: "Proyecto MOS COMMUNI MANAGER",
      imagen: projImg5
    },
    {
      titulo: "Proyecto 6",
